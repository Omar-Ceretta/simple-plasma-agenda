...
Se KDE PIM/Akonadi e `pimevents` sono già configurati, puoi scaricare l'asset stabile dalla [release più recente](https://github.com/Omar-Ceretta/simple-plasma-agenda/releases/latest/download/Simple-Plasma-Agenda.plasmoid) e installarlo con:
