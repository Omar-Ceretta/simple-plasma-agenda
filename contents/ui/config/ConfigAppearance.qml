...
ColumnLayout {
    ...
    property int cfg_eventLookaheadDays: 2
    ...
    Kirigami.InlineMessage {
        ...
        text: i18nd(root.trDomain, "Solid follows the Plasma color scheme and is the recommended default. Translucent keeps the same colors with a lighter background.")
    }
